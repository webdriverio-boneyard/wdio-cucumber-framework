...
const CucumberReporterMethods = [
    'handleBeforeFeatureEvent', 'handleBeforeScenarioEvent',
    'handleStepResultEvent', 'handleAfterScenarioEvent',
    'handleAfterFeatureEvent']
...
class CucumberAdapter {
    ...
    wrapStep (code, stepOpts) {
        ...
        return function (...args) {
            return executeHooksWithArgs(self.config.beforeTest, stepOpts).then(
                () => new Promise((r) => global.wdioSync(code, r).apply(this, args)),
                (e) => console.log(`Error in beforeTest hook: [${e}]`)
            ).then(
                () => executeHooksWithArgs(self.config.afterTest, stepOpts)
...
export { CucumberAdapter, adapterFactory, CucumberReporterMethods }
