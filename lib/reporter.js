...
const CucumberReporterMethods = [
    'handleBeforeFeatureEvent', 'handleBeforeScenarioEvent', 'handleStepResultEvent',
    'handleAfterScenarioEvent', 'handleAfterFeatureEvent']

/**
 * Custom Cucumber Reporter
 */
class CucumberReporter {
    constructor (BaseListener, options, cid) {
        ...
        for (const fnName of CucumberReporterMethods) {
