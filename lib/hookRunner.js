...
class HookRunner {
    ...
    handleBeforeFeatureEvent (event) {
        ...
        return exec.catch((e) => {
            console.error(`beforeFeature has thrown an error: ${e.stack.slice(7)}`)
            done()
        })
    }
    ...
    handleBeforeScenarioEvent (event) {
        ...
        return exec.catch((e) => {
            console.error(`beforeScenario has thrown an error: ${e.stack.slice(7)}`)
            done()
        })
    }
    ...
    handleBeforeStepEvent (event) {
        ...
        return exec.catch((e) => {
            console.error(`beforeStep has thrown an error: ${e.stack.slice(7)}`)
            done()
        })
    }
    ...
    handleStepResultEvent (event) {
        ...
        return exec.catch((e) => {
            console.error(`afterStep has thrown an error: ${e.stack.slice(7)}`)
            done()
        })
    }
    ...
    handleAfterScenarioEvent (event) {
        ...
        return exec.catch((e) => {
            console.error(`afterScenario has thrown an error: ${e.stack.slice(7)}`)
            done()
        })
    }
    ...
    handleAfterFeatureEvent (event) {
        ...
        return exec.catch((e) => {
            console.error(`afterFeature has thrown an error: ${e.stack.slice(7)}`)
            done()
        })
    }
}
